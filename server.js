...
    console.log(`🎥 [Video] ${socket.userName} (ID: ${socket.id}) joined room ${room} with Peer ID ${peerId}`);
    ...
    // अब जो लोग पहले से रूम में हैं, वे नए यूज़र को कॉल नहीं करेंगे।
...
    // ✅ Step 3: (सही तरीका) - नए यूज़र को बताएँ कि रूम में कौन है
    // सिर्फ नया यूज़र (socket) कॉल शुरू करेगा।
    const clients = io.sockets.adapter.rooms.get(room);
    if (clients) {
      clients.forEach((clientId) => {
        // लूप में खुद को (नए यूज़र को) छोड़कर...
        if (clientId !== socket.id) {
          // ...बाकी सभी पुराने यूज़र्स की जानकारी लो
          const s = io.sockets.sockets.get(clientId);
          if (s?.peerId) {
            // और नए यूज़र को बताओ कि इन्हें कॉल करना है
